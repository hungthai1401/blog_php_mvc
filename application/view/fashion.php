        ...
        <div class="col-md-9 technology-left">
            <div class="blog">
                ...
                <div class="blog-grids1">
                    <?php
                    foreach ($row_fashion as $r) {
                        ?>
                        <div class="col-md-6 blog-grid" style="height: 500px ">
                            <div class="blog-grid-left1">
                                <a href="/blogs/detail/<?php echo $r["blog_id"] ?>"><img src="/<?php echo $r["image"] ?>" alt=" "
                                                               class="img-responsive" style="width: 300px; height: 200px;"></a>
                            </div>
                            <div class="blog-grid-right1">
                                <a href="/blogs/detail/<?php echo $r["blog_id"] ?>"><?php echo $r["title"] ?></a>
                                <h4><?php echo $r["created_at"] ?></h4>
                                <p><?php echo $r["description"] ?></p>
                            </div>
                            <div class="clearfix"></div>
                            <div class="more m1">
                                <a class="btn effect6" href="/blogs/detail/<?php echo $r["blog_id"] ?>">Đọc tiếp</a>
                            </div>
                        </div>
                        <?php
                    }
                ...
                <nav class="paging">
                    <ul class="pagination pagination-lg">
                        <li><a href="<?php echo URL ?>Blogs/fashion?trang=<?php echo $trang - 1 ?>" aria-label="Previous"><span aria-hidden="true"><<</span></a></li>
                        <?php if ($so_trang < 5) { for ($i = 1; $i <= $so_trang; $i++) {?>
                            <li><a href="<?php echo URL ?>Blogs/fashion?trang=<?php echo $i ?>"><?php echo $i ?></a></li>

                        <?php } } else { for ($i = $trang; $i <= $trang + 4; $i++) {?>
                            <li><a href="<?php echo URL ?>Blogs/fashion?trang=<?php echo $i ?>"><?php echo $i ?></a></li>
                        <?php }}?>

                        <li><a href="<?php echo URL ?>Blogs/fashion?trang=<?php echo $trang + 1 ?>" aria-label="Next"><span aria-hidden="true">>></span></a></li>
                    </ul>
                </nav>
